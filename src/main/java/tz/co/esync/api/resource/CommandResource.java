...
import tz.co.esync.ServerManager;
import tz.co.esync.api.ExtendedObjectResource;
import tz.co.esync.command.CommandSender;
import tz.co.esync.command.CommandSenderManager;
import tz.co.esync.database.CommandsManager;
import tz.co.esync.helper.LogAction;
import tz.co.esync.helper.model.DeviceUtil;
...
import tz.co.esync.model.QueuedCommand;
