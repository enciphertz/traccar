...
import tz.co.esync.schedule.ScheduleManager;
import tz.co.esync.storage.DatabaseModule;
import tz.co.esync.web.WebModule;
...
public final class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length > 0 && args[0].startsWith("--")) {
            WindowsService windowsService = new WindowsService("esync-telemetries") {
                @Override
                public void run() {
                    Main.run(configFile);
                }
