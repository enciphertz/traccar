...
import tz.co.esync.broadcast.MulticastBroadcastService;
import tz.co.esync.broadcast.RedisBroadcastService;
import tz.co.esync.broadcast.NullBroadcastService;
import tz.co.esync.config.Config;
import tz.co.esync.config.Keys;
import tz.co.esync.database.LdapProvider;
import tz.co.esync.database.OpenIdProvider;
import tz.co.esync.database.StatisticsManager;
import tz.co.esync.forward.EventForwarder;
import tz.co.esync.forward.EventForwarderJson;
import tz.co.esync.forward.EventForwarderAmqp;
import tz.co.esync.forward.EventForwarderKafka;
import tz.co.esync.forward.EventForwarderMqtt;
import tz.co.esync.forward.PositionForwarder;
import tz.co.esync.forward.PositionForwarderJson;
import tz.co.esync.forward.PositionForwarderAmqp;
import tz.co.esync.forward.PositionForwarderKafka;
import tz.co.esync.forward.PositionForwarderRedis;
import tz.co.esync.forward.PositionForwarderUrl;
import tz.co.esync.forward.PositionForwarderMqtt;
import tz.co.esync.forward.PositionForwarderWialon;
import tz.co.esync.geocoder.AddressFormat;
import tz.co.esync.geocoder.BanGeocoder;
import tz.co.esync.geocoder.BingMapsGeocoder;
import tz.co.esync.geocoder.FactualGeocoder;
import tz.co.esync.geocoder.GeoapifyGeocoder;
import tz.co.esync.geocoder.GeocodeFarmGeocoder;
import tz.co.esync.geocoder.GeocodeXyzGeocoder;
import tz.co.esync.geocoder.Geocoder;
import tz.co.esync.geocoder.GisgraphyGeocoder;
import tz.co.esync.geocoder.GoogleGeocoder;
import tz.co.esync.geocoder.HereGeocoder;
import tz.co.esync.geocoder.LocationIqGeocoder;
import tz.co.esync.geocoder.MapQuestGeocoder;
import tz.co.esync.geocoder.MapTilerGeocoder;
import tz.co.esync.geocoder.MapboxGeocoder;
import tz.co.esync.geocoder.MapmyIndiaGeocoder;
import tz.co.esync.geocoder.NominatimGeocoder;
import tz.co.esync.geocoder.OpenCageGeocoder;
import tz.co.esync.geocoder.PositionStackGeocoder;
import tz.co.esync.geocoder.PlusCodesGeocoder;
import tz.co.esync.geocoder.TomTomGeocoder;
import tz.co.esync.geocoder.GeocodeJsonGeocoder;
import tz.co.esync.geolocation.GeolocationProvider;
import tz.co.esync.geolocation.GoogleGeolocationProvider;
import tz.co.esync.geolocation.OpenCellIdGeolocationProvider;
import tz.co.esync.geolocation.UniversalGeolocationProvider;
import tz.co.esync.geolocation.UnwiredGeolocationProvider;
import tz.co.esync.handler.CopyAttributesHandler;
import tz.co.esync.handler.FilterHandler;
import tz.co.esync.handler.GeocoderHandler;
import tz.co.esync.handler.GeolocationHandler;
import tz.co.esync.handler.SpeedLimitHandler;
import tz.co.esync.helper.LogAction;
import tz.co.esync.helper.ObjectMapperContextResolver;
import tz.co.esync.helper.WebHelper;
import tz.co.esync.mail.LogMailManager;
import tz.co.esync.mail.MailManager;
import tz.co.esync.mail.SmtpMailManager;
import tz.co.esync.session.cache.CacheManager;
import tz.co.esync.sms.HttpSmsClient;
import tz.co.esync.sms.SmsManager;
import tz.co.esync.sms.SnsSmsClient;
import tz.co.esync.speedlimit.OverpassSpeedLimitProvider;
import tz.co.esync.speedlimit.SpeedLimitProvider;
import tz.co.esync.storage.DatabaseStorage;
import tz.co.esync.storage.MemoryStorage;
import tz.co.esync.storage.Storage;
import tz.co.esync.storage.TenantAwareStorage;
import tz.co.esync.web.WebServer;
...
public class MainModule extends AbstractModule {
    ...
    @Singleton
    @Provides
    public static TenantAwareStorage provideTenantAwareStorage(
            Storage storage, CacheManager cacheManager, javax.sql.DataSource dataSource) {
        return new TenantAwareStorage(storage, cacheManager, dataSource);
    }
