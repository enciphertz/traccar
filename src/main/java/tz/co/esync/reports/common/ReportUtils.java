 ...
 */
package tz.co.esync.reports.common;
...
import tz.co.esync.api.security.PermissionsService;
...
import tz.co.esync.reports.model.BaseReportItem;
import tz.co.esync.reports.model.StopReportItem;
import tz.co.esync.reports.model.TripReportItem;
import tz.co.esync.session.state.MotionProcessor;
import tz.co.esync.session.state.MotionState;
